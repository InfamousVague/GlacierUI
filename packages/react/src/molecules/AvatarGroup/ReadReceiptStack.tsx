...
import { AvatarGroup, type AvatarGroupProps, type AvatarStackItem } from './AvatarGroup.tsx';

export type { ReadReceiptLabels };

export interface ReadReceiptStackProps
  // Everything geometric is the preset's; only what a receipt genuinely tunes
  // is exposed, so it cannot quietly become a second AvatarGroup with different
  // defaults.
 ...
 * cap — because a receipt is a footnote to the message above it and must not
 * outweigh it. The only thing it adds is the sentence, since "Ada, Grace, 2
 * more" under a bubble is ambiguous in a way "Read by Ada, Grace, 2 more" is
 * not.
 */
