  ...
  if (skeleton) {
    return (
      <div className={cx(styles.emptyState, className)} {...rest}>
        <Skeleton variant={SkeletonVariant.Circle} width="4rem" className={styles.disc} />
        <Skeleton variant={SkeletonVariant.Text} width="12ch" style={{ fontSize: 'var(--glacier-font-size-lg)' }} />
        <Skeleton variant={SkeletonVariant.Text} width="24ch" style={{ fontSize: 'var(--glacier-font-size-sm)' }} />
      </div>
    );
  }
  return (
