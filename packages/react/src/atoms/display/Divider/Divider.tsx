import { dividerOrientations } from '@glacier/spec';
...
export function Divider({
  ...
  if (skeleton) {
    return orientation === 'vertical' ? (
      <Skeleton width="var(--glacier-hairline)" height="1.5rem" className={className} />
    ) : (
      <Skeleton width="100%" height="var(--glacier-hairline)" className={className} />
    );
  }
  if (label) {
    return (
