...
export function TimelineScrubber({
  ...
  // The activity silhouette: the exact same 0..100 viewBox geometry the DOM kit
  // draws, as an area chart. Crest and wash are two paths off one line: an open
  // path for the stroke, and the same line closed to the baseline for the fill.
  // Stroking the closed path would outline the bottom and sides too.
  const activityLine =
