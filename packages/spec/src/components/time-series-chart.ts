...
export const timeSeriesChartSpec: ComponentSpec = {
  ...
  defaults: { shape: 'line', showLegend: true, height: '12rem', emptyLabel: 'No samples yet', glass: false, skeleton: false },
  dimensions: {
    strokeWidth: '2px',
    gridWidth: token('hairline'),
    gap: token('space-3'),
    radius: token('radius-md'),
    glassPadding: token('space-3'),
  ...
  states: [
    ...
    {
      name: 'glass',
      description: 'The plot region gains the frosted material frame: blurred, saturated, with an inset top highlight.',
