...
export const timelineScrubberSpec: ComponentSpec = {
  ...
  anatomy: [
    ...
    { name: 'playhead', description: 'The draggable vertical line with a grab handle; its position is the inspected time.', required: true },
  ...
  props: [
    ...
    { name: 'size', type: 'enum', values: compactSizes, default: 'md', description: 'Track height step.' },
  ...
  defaults: { step: 1000, liveLabel: 'Live', size: 'md', disabled: false, skeleton: false },
  dimensions: {
