...
export const filterChipSpec: ComponentSpec = {
  ...
  states: [
    { name: 'hover', description: 'An unselected chip lifts to the hover background and full-strength text.', tokens: { background: token('hover'), text: token('text') } },
    {
      name: 'selected',
    ...
    { name: 'selected-hover', description: 'A selected chip deepens to the accent soft hover fill.', tokens: { background: token('accent-soft-hover') } },
