// English-only search metadata (not translated): concept keywords and cross-tags per page.
...
export const pageConcepts: Record<string, string> = {
  ...
  "cardfan": "cards hand fan deck spread arc slinky magnify dock game",
  ...
  "shapesmotion": "shape slant notch edge plate silhouette parallelogram gradient wash sweep glow stagger rise animation game",
