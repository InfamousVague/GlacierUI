  ...
  return (
    <>
      ...
      <Example
        ...
        code={`import { NumberInput } from '@perfect/react';
...
<Text as="span" size="sm" tone="muted" mono>{quantity} in cart</Text>`}
      >
        <NumberInput aria-label="Quantity" value={quantity} onValueChange={setQuantity} />
      ...
      <Example
        ...
        code={`<NumberInput aria-label="Small" size="sm" defaultValue={1} />
