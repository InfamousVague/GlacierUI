...
import { Button, TabbedPanel } from '@perfect/react';
import { Example, PropsTable } from '../docs-ui.tsx';

const overview = <p>Traffic is up 12% week over week, with mobile leading the gain.</p>;
const activity = <p>Six new comments and two mentions since you last checked in.</p>;
const settings = <p>Notifications, visibility, and export options live here.</p>;
...
function ControlledExample() {
  ...
  return (
    <TabbedPanel
      ...
      tabs={[
        { id: 'inbox', label: 'Inbox', count: 8, content: <p>Eight unread threads.</p> },
        { id: 'archive', label: 'Archive', content: <p>Everything you have filed away.</p> },
        { id: 'spam', label: 'Spam', count: 132, content: <p>Filtered senders.</p> },
      ]}
    />
  );
}
  ...
  return (
    <>
      ...
      <Example
        ...
        code={`import { TabbedPanel } from '@perfect/react';
...
/>`}
      ...
      <Example
        ...
        code={`<TabbedPanel
  aria-label="Queue"
  actions={<Button variant="soft" size="sm">Refresh</Button>}
  tabs={[
...
/>`}
      >
        <TabbedPanel
          ...
          tabs={[
            { id: 'open', label: 'Open', count: 3, content: <p>Three items need attention.</p> },
            { id: 'done', label: 'Done', count: 128, content: <p>Completed this week.</p> },
          ]}
        />
      </Example>
...
/>`}
      >
        <TabbedPanel
          aria-label="Plan"
          tabs={[
            { id: 'usage', label: 'Usage', content: <p>Current period usage.</p> },
            { id: 'billing', label: 'Billing', disabled: true, content: <p>Upgrade to manage billing.</p> },
          ]}
        />
      </Example>
