...
<Select size={Size.Large} aria-label="Large" options={options} defaultValue="apple" />`}
      >
        <Select size={Size.Small} aria-label="Small" options={FRUIT} defaultValue="apple" />
        <Select size={Size.Medium} aria-label="Medium" options={FRUIT} defaultValue="apple" />
        <Select size={Size.Large} aria-label="Large" options={FRUIT} defaultValue="apple" />
      </Example>
...
<Select aria-label="Fruit" options={options} defaultValue="apple" />`}
      ...
      />
      <Heading level={3}>options entries</Heading>
      <PropsTable
        props={[
