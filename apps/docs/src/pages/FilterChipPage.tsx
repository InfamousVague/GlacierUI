...
import { FilterChip } from '@perfect/react';
...
function ControlledFilters() {
  ...
  return (
    <div style={{ display: 'flex', gap: 'var(--perfect-space-2)', flexWrap: 'wrap' }}>
  ...
  return (
    <>
      ...
      <Example
        ...
        code={`import { FilterChip } from '@perfect/react';

<FilterChip defaultSelected>Available</FilterChip>
<FilterChip>On sale</FilterChip>`}
      >
        <div style={{ display: 'flex', gap: 'var(--perfect-space-2)' }}>
          <FilterChip defaultSelected>Available</FilterChip>
          <FilterChip>On sale</FilterChip>
        </div>
      </Example>
...
<FilterChip selected={active.open} onSelectedChange={(v) => setActive((p) => ({ ...p, open: v }))} count={12}>
  Open
      ...
      <Example
        ...
        code={`<FilterChip size="sm" count={4}>Small</FilterChip>
<FilterChip size="md" count={4}>Medium</FilterChip>
<FilterChip disabled count={0}>Disabled</FilterChip>`}
      >
        <div style={{ display: 'flex', gap: 'var(--perfect-space-2)', alignItems: 'center' }}>
          <FilterChip size="sm" count={4}>
            Small
          </FilterChip>
          <FilterChip size="md" count={4}>
            Medium
          </FilterChip>
