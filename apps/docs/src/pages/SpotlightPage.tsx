...
import { Button, Spotlight } from '@perfect/react';
...
function TourDemo() {
  ...
  return (
    <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap' }}>
      ...
      <Button ref={createRef} variant="soft">
        New
      </Button>
      <Button ref={bellRef} variant="ghost" aria-label="Notifications">
        🔔
      </Button>
...
function SingleStepDemo() {
  ...
  return (
    <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
      <Button ref={ref} variant="soft" onClick={() => setOpen(true)}>
        Highlight me
      </Button>
      <Spotlight
        open={open}
