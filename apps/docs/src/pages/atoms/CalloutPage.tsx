import { Box, Callout, Stack, Heading, Text, Size, TextTone, Tone } from '@glacier/react';
...
<Callout tone={Tone.Danger} title="Danger">This action cannot be undone.</Callout>`}
      >
        <Stack gap={4} style={{ width: '100%', maxWidth: '34rem' }}>
          <Callout title="Note">A neutral aside on the default surface.</Callout>
          <Callout tone={Tone.Info} title="Info">
            Extra context that is good to know.
          </Callout>
          <Callout tone={Tone.Success} title="Success">
            Your changes were saved.
          </Callout>
          <Callout tone={Tone.Warning} title="Warning">
            This will overwrite existing data.
          </Callout>
          <Callout tone={Tone.Danger} title="Danger">
  ...
  Press <kbd>⌘K</kbd> anywhere to open the command palette.
      ...
      >
        <Box style={{ width: '100%', maxWidth: '34rem' }}>
          <Callout tone={Tone.Info} title="Keyboard shortcut" icon={<Lightbulb size={18} />}>
      ...
      >
        <Box style={{ width: '100%', maxWidth: '34rem' }}>
          <Callout tone={Tone.Success}>Everything is up to date.</Callout>
        </Box>
      </Example>
