import { Box, Center, Container, Grid, Row, Spacer, Stack, Text } from '@perfect/react';
  ...
  return (
    <>
      ...
      <Example
        ...
        code={`import { Stack } from '@perfect/react';
...
<Stack gap={4}>
  ...
  <div>Third</div>
      ...
      <Example
        ...
        code={`import { Row, Spacer, Button } from '@perfect/react';
...
<Row gap={3}>
  ...
  <Stack gap={2}>
    ...
    <Text size="sm" tone="muted">Ready to review.</Text>
  </Stack>
</Box>`}
      >
  ...
  <Text tone="muted">Nothing here yet</Text>
      ...
      <h2>Props</h2>
      <h3>Box style props (shared by every primitive)</h3>
      <PropsTable
        props={[
