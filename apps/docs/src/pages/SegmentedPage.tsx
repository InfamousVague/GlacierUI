  ...
  return (
    <>
      ...
      <Example
        ...
        code={`import { SegmentedControl } from '@perfect/react';
...
<div className="row">
  ...
  <span>Showing the {view} view</span>
      ...
      <Example
        ...
        code={`import { Spring } from '@perfect/motion';
...
<SegmentedControl spring={Spring.Bouncy} aria-label="Bouncy demo" options={options} />`}
      ...
      <Example
        ...
        code={`<SegmentedControl size="sm" aria-label="Small" options={options} />
...
/>`}
      ...
      <PropsTable
        props={[
          ...
          },
          {
            ...
            description:
              'Spring preset for the thumb transition. Import Spring from @perfect/motion.',
          },
          {
            name: 'disabled',
            type: 'boolean',
      ...
      <h3>options entries (SegmentedOption)</h3>
      <PropsTable
        props={[
          {
            name: 'value',
